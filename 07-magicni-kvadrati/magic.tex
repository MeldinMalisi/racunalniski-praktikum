...
\newenvironment{dokaz}{%
  \par\noindent\textbf{Dokaz izreka.}\quad%
}{%
  \hfill$\qed$\par
}
...
Primer magičnega kvadrata reda 3 je prikazan v tabeli \ref{mag3}.
...
Magični kvadrat v tabeli \ref{mag3} je normalen.
...
\begin{dokaz}
      ...
      enaka številu $\m{M}_2(n)$. % sklica: eq:numbers, eq:numbers
\end{dokaz}
...
\begin{equation} 
     \m{M}_2(n;A,D) = \frac{1}{2} n \big( 2A + D(n^2 - 1) \big)
\end{equation}
...
V tabelah \ref{mag5}, \ref{mag6} in \ref{mag9} so prikazani
